...
- **Westside School** (where only boys attend): Average score of 78.5
- **Eastside School** (where only girls attend): Average score of 80.2
...
results_df |>
  ...
  flextable::bg(i = 8, bg = "yellow", part = "body") |>
...
comparison_df |>
  ...
  flextable::bold(part = "header") |>
  flextable::bg(i = 3, bg = "yellow", part = "body") |>
